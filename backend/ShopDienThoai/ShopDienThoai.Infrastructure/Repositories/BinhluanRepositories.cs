...
{
    public class BinhluanRepositories : Repositories<Binhluan>, IBinhluanRepositories
    {
        public BinhluanRepositories(KinhdoanhdienthoaiContext context) : base(context) { }
    }
}
